...
Beide Systeme können von Haus aus nur kompilieren, nicht ausführen. Erst ein Plugin (exec-maven-plugin / application bei Gradle) macht aus "Code bauen" ein "Code starten". Das war mir vorher nicht bewusst.
